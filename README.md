...
| Follow-up com IA | A cada passo da régua, a IA (Gemini grátis com `GEMINI_API_KEY`, ou Claude com `ANTHROPIC_API_KEY`) escreve a mensagem daquela paciente no campo "Follow-up · mensagem", com trava de segurança; o robô da etapa envia. Sem chave ou se a IA errar, vai a mensagem aprovada. |
